...
| Finagle/Thrift Service Framework | Prodigal Service Framework | Developer Productivity | 2022 |
| Self-Running Apache Kafka on VMs in the cloud | Purchase Confluent Kafka-as-a-Service Kafka Topics Managed in Infrastructure as Code in a CD pipeline | Developer Productivity Infra Cost Efficiency | 2022 |
...
| Jobs Inputs/Outputs in Cloud Storage | Job Inputs/Outputs in Redis | Developer Productivity | 2022 |
| API Framework V0 | API Framework V1 | Developer Productivity | 2022 |
| ADLS Gen 1 | ADLS Gen 2 | Infra cost efficiency System reliability Security posture Developer Productivity | 2021 |
| Loggly for structured logs \+ Honeycomb for traces | Honeycomb for traces and structured logs | Infra cost efficiency Developer productivity Security posture | 2023 |
| Plain Text Logging | Structured Logging and Tracing | Speed to debug/resolve incidents Developer productivity | 2021 |
| Deprecated Azure Public IP | Modern Azure Public IP | BFD: Connections to customer systems won't break when Azure retires their old infra Developer productivity | 2024 |
| Loading Dock | Not Loading Dock | Security Developer productivity | 2024 |
| Tables In Accumulo \+ HDFS | Files in Cloud Storage, removal of Accumulo/HDFS | Infra cost efficiency Developer productivity | 2020 |
| HDFS | Cloud Storage, full removal of HDFS | Infra cost efficiency Developer productivity | idk |
| Product Configuration in Spaghetti/Accumulo | Unified Product Configuration | Sandboxes Developer productivity | idk |
| Service Data in Spaghetti/Accumulo | Service Data in PostgreSQL | Sandboxes Developer productivity | idk |
...
* Amperity staff engineering discussions  
  * [slack](https://amperity.slack.com/archives/C05TRF2M4MP/p1730843186759479)  
  * [slack](https://amperity.slack.com/archives/C05TRF2M4MP/p1730925622673299)  
  * [slack](https://amperity.slack.com/archives/C05TRF2M4MP/p1730926827302989)  
  * AI summary of meeting: [Simple vs Easy AI Summaries](https://docs.google.com/document/d/1J_PWuYGuk7QbQUHm8-wQPlVvxNU72sVwqTkGl4VQ_Fc/edit?tab=t.0)  
